...
class _EditProfileScreenState extends SafeState<EditProfileScreen> {
  ...
  // additional colors borrowed from profile page for input styling
  static const Color _dark = Color(0xFF1A1A2E);
  static const Color _fieldBg = Color(0xFFF5F5F8);
  ...
  // common input decoration used across the edit form
  ...
  Widget _buildHeader(String name, String? email) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(
            color: Color(0x4D3B82F6), // _accent with 30% opacity
            blurRadius: 20,
            offset: Offset(0, 8),
          ),
        ],
        ...
        children: [
          ...
          if (email != null && email.isNotEmpty) ...[
            ...
            Text(
              ...
              style: GoogleFonts.poppins(
                fontSize: 13,
                color: const Color(0xCCFFFFFF), // white at 80% opacity
              ),
            ),
          ],
        ],
  ...
  Future<void> _submit() async {
    ...
    // capture context-derived objects before any awaits to avoid async-gap warnings
    ...
    final updated = await userProfileProv.updateProfile(profile);
    ...
    if (updated) {
      ...
      if (mounted) {
        scaffold.showSnackBar(
          SnackBar(
            content: Text(userProfileProv.errorMessage ?? 'Update failed'),
          ),
        );
      }
    }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              decoration: _inputDecoration('Contractor Type'),
                              style: GoogleFonts.poppins(
                                fontSize: 15,
                                color: _dark,
                              ),
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              decoration: _inputDecoration('Contractor Class'),
                              style: GoogleFonts.poppins(
                                fontSize: 15,
                                color: _dark,
                              ),
